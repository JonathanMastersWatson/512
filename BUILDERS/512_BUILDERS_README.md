...
512 is a discovered constraint. The documents here define what it is, how to
build a system that satisfies its properties, and how it relates to the broader
...
|---|---|---|
| `512_ARCHITECTURE_v3.4.md` | CTO / Board | What 512 is, why physics forces the Commit Gate into existence, the seven invariants, the open commons model |
...
**If you are a CTO or board member:** Read `512_ARCHITECTURE_v3.4.md` first.
